...
[CreateAssetMenu(fileName = "SO_ManaDrainAction", menuName = "BattleActions/SO_ManaDrainAction")]
public class SO_ManaDrainAction : AbstractBattleActionSO
{
    ...
    public override void Act(BattleFieldMB field)
    {
        ...
        //AnimationFunctions.AnimateAttackTarget(battlefield, attackerGO, targetGO, damage, this.manaCost);
        IEnumerator attackAnimation = AnimationFunctions.AnimateManaDrain(attackerMB,targetMB, damage);
        IEnumerator attackSequence = AnimationFunctions.AttackCellSequence(field, attackerGO, targetGO,attackAnimation, manaCost);
