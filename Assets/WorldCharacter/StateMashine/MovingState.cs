...
public class MovingState : AbstractState
{
    ...
    public static string animationName = "Walking";
    ...
    void UpdateVisualsForward(StateManager ctx, Vector3 moveDir)
    {
        float delta = ctx.fixedDeltaTime;
        Transform characterVisuals = ctx.characterVisualsForRotate;
